...
public class ProjectsHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo {Title = "Projects API", Version = "v1"});
        ...
        {
            options.KeyPrefix = "Projects:";
        });

        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("Projects");
        if (!hostingEnvironment.IsDevelopment())
        {
